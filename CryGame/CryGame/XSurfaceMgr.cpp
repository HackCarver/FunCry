...
//
//  File: XSurfaceMgr.cpp
//  Description: implementation of the CXSurfaceMgr class.
//
//  History:
...
{
	// load the material
	// NOTE :The new surface id is generated also if the same material
	// is already mapped to a surface id, this to map correctly the terrain surface id(that we cannot modify)
