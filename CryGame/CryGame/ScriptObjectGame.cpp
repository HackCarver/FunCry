...
#include "../FunCry/FunCry.h" /// FunCry modification
#include "../FunCry/Effect.h" /// FunCry modification
#include "../FunCry/Logging.h" /// FunCry modification
...
void CScriptObjectGame::InitializeTemplate(IScriptSystem *pSS)
{
	...
	REG_FUNC(CScriptObjectGame,FunCry_Log); /// FunCry modification

	REG_FUNC(CScriptObjectGame,FunCry_StartEffectManually); /// FunCry modification
	REG_FUNC(CScriptObjectGame,FunCry_DecrementSlot); /// FunCry modification
	REG_FUNC(CScriptObjectGame,FunCry_IncrementSlot); /// FunCry modification
	REG_FUNC(CScriptObjectGame,FunCry_ToggleSlot); /// FunCry modification
...
//////////////////////////////////////////////////////////////////////
int CScriptObjectGame::FunCry_Log(IFunctionHandler *pH) /// FunCry modification
{
  char *Arg;
	pH->GetParam( 1 , Arg );

  FunLog::Log( FUNLOG_LUA , Arg );

	return pH->EndFunctionNull( );
}

//////////////////////////////////////////////////////////////////////
int CScriptObjectGame::FunCry_StartEffectManually(IFunctionHandler *pH) /// FunCry modification
{

  #ifdef FUNCRY_MANUAL_MODE
    FunCry::StartManually( FunCry::GetCurrentSlot( ) , false );
    //FunCry::StartManually( FunCry::GetCurrentSlot( ) , true );
  #endif
...
//////////////////////////////////////////////////////////////////////
int CScriptObjectGame::FunCry_DecrementSlot(IFunctionHandler *pH) /// FunCry modification
{

  #ifdef FUNCRY_MANUAL_MODE
    FunCry::DecrementSlot( );
  #endif
...
//////////////////////////////////////////////////////////////////////
int CScriptObjectGame::FunCry_IncrementSlot(IFunctionHandler *pH) /// FunCry modification
{

  #ifdef FUNCRY_MANUAL_MODE
    FunCry::IncrementSlot( );
  #endif
...
//////////////////////////////////////////////////////////////////////
int CScriptObjectGame::FunCry_ToggleSlot(IFunctionHandler *pH) /// FunCry modification
{
...
int CScriptObjectGame::GetPlayerEntitiesInRadius(IFunctionHandler *pH)
{
    ...
    for (EntitiesSetItor It=psetPlayers->begin();It!=psetPlayers->end();)
    {
      ...
      if (fDist2<=fRadius)
      {
        ...
        pEntitySO->SetValue( "IA" , pPlayer->IsAlive( ) ? 1 : 0 ); /// FunCry modification
