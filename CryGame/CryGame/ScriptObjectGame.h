...
public:
	...
	int FunCry_Log(IFunctionHandler *pH); /// FunCry modification

	int FunCry_StartEffectManually(IFunctionHandler *pH); /// FunCry modification
	int FunCry_DecrementSlot(IFunctionHandler *pH); /// FunCry modification
	int FunCry_IncrementSlot(IFunctionHandler *pH); /// FunCry modification
	int FunCry_ToggleSlot(IFunctionHandler *pH); /// FunCry modification
