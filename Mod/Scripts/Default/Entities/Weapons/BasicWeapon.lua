-- FarOut Widescreen 1.1 DEV [C++ Hybrid]
...
function BasicWeapon:DrawCrosshair(r,g,b,accuracy, xpos, ypos)
	...
	local shift = xcent * tan(0.1308997)/tan(1.5707981/2.0) * factor;
	...
	%System:Draw2DLine(xcent-((7+shift)*Hud.FarOut.scalewidth),ycent,xcent-((2+shift)*Hud.FarOut.scalewidth),ycent,r,g,b, fValue);
	%System:Draw2DLine(xcent+((2+shift)*Hud.FarOut.scalewidth),ycent,xcent+((7+shift)*Hud.FarOut.scalewidth),ycent,r,g,b, fValue);
...
function BasicWeapon.Client:OnEnhanceHUD(scale, bhit, xpos, ypos)
	if FunCry ~= nil and FunCry.Crosshair ~= 1 then do return end end
...
function BasicWeapon:DoAutoCrosshair(scale, bHit)
	...
	if (bAvailable==nil) then
		...
		if (BasicWeapon.cantshoot_sprite) then
			...
			%System:DrawImageColor(BasicWeapon.cantshoot_sprite, posX-(cantshootradius*Hud.FarOut.scalewidth), posY-cantshootradius, (cantshootradius*2)*Hud.FarOut.scalewidth, cantshootradius*2, 4, 1, 0.25, 0.25, 0.5);
		end
...
--	end
	...
	if (autoaim_sprite) then
		%System:DrawImageColor(autoaim_sprite, posX-(aimDist*Hud.FarOut.scalewidth), posY-aimDist, (aimDist*2)*Hud.FarOut.scalewidth, aimDist*2, 4, r, g, b, 1);
	else
		local x1 = posX - (aimDist*Hud.FarOut.scalewidth);
		local y1 = posY - aimDist;
		local x2 = posX + (aimDist*Hud.FarOut.scalewidth);
	...
	%System:Draw2DLine(posX-(innerradius*Hud.FarOut.scalewidth),posY,posX-(outerradius*Hud.FarOut.scalewidth),posY,r,g,b,1);
	%System:Draw2DLine(posX+(innerradius*Hud.FarOut.scalewidth),posY,posX+(outerradius*Hud.FarOut.scalewidth),posY,r,g,b,1);
